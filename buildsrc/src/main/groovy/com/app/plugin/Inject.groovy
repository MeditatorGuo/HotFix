...
public class Inject {
        ...
        if (dir.isDirectory()) {
            ...
            dir.eachFileRecurse { File file ->
                ...
                if (filePath.endsWith(".class")
                    ...
                    int index = filePath.indexOf("com\\aliex\\hotfix")
                    if (index != -1) {
    ...
    private static void injectClass(String className, String path) {
        ...
        //再构造函数中添加System.out.println(com.aliex.hack.AntilazyLoad.class);
        def constructor = c.getConstructors()[0];
        constructor.insertAfter("System.out.println(com.aliex.hack.AntilazyLoad.class);")
        c.writeFile(path)
    }
